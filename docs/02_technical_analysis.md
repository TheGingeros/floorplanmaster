...
## 6. Uživatelského rozhraní - jak definovat a vykreslovat UI
## [Princip vykreslování](./files/02_user_interface_posibilities.md#princip-vykreslování)
## [Hiearchie členění prostoru obrazovky](./files/02_user_interface_posibilities.md#hiearchie-členění-prostoru-obrazovky)
## [Datový most mezi UI a daty](./files/02_user_interface_posibilities.md#datový-most-mezi-ui-a-daty)
## [Systém Gizmos manipulátorů](./files/02_user_interface_posibilities.md#systém-gizmos-manipulátorů)
## [Propojení manipulátorů s datovým modelem](./files/02_user_interface_posibilities.md#propojení-manipulátorů-s-datovým-modelem)
## [Kontextově senzitivní rozhraní pro architektonické prvky](./files/02_user_interface_posibilities.md#kontextově-senzitivní-rozhraní-pro-architektonické-prvky)
