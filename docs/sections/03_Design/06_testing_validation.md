...
Viz [06_testing_validation_requirements.md](./06_testing_validation_requirements.md).

## Průchod scénáři použití

Viz [06_testing_validation_walkthroughs.md](./06_testing_validation_walkthroughs.md).

## Analýza okrajových případů

Viz [06_testing_validation_edge_cases.md](./06_testing_validation_edge_cases.md).
